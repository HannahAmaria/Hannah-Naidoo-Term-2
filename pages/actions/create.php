...
if ($db == "receptionist") {
        ...
        // --sql query:
        $sql = "INSERT INTO receptionist (RecepID, ProfileImg, Name, Surname, Age, Gender, PhoneNumber, Email, , Rank, SignedIn) 
        ...
        // --sql query:
        $sql = "INSERT INTO appointments (DoctorID, PatientID, RecepID, DoctorRoom, AppointmentDate) 
