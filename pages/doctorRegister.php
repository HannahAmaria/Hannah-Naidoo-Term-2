...
<body id="bg_signin" class="actor" style="width: 99%;">
    ...
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="col">
            <h1 style="margin-left: 150px; font-size: 60px; width: 600px;">New Doctor? <br> Create an Account!</h1>
        </div>

        <!-- --Input Form -->
        <form method="post" action="actions/create.php?db=doctor" class="col" style="margin-left: 15%;">
            ...
            <div class="input-group mb-3 input_signin">
                <input type="text" style="border-right: 0px; border-color: black;" class="form-control"
                    name="specialization" placeholder="Enter Specialization" id="SignUp_Pass_Input">
                <button class="btn btn_signin" type="button" style="width: 50px;"><span>&#10005;</span></button>
            </div>
            ...
            <div class="input-group mb-3 input_signin">
                <input type="text" style="border-right: 0px; border-color: black;" class="form-control"
                    name="doctorroom" placeholder="Enter Doctor Room" id="SignUp_Pass_Input">
                <button class="btn btn_signin" type="button" style="width: 50px;"><span>&#10005;</span></button>
            </div>
