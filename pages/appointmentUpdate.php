...
<body id="bg_signin" class="actor" style="width: 99%;">
    ...
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="col">
            <h1 style="margin-left: 150px; font-size: 60px; width: 600px;">Incorrect Appointment?</h1>
        </div>

        <!-- --Input Form -->
        <form method="post" action="actions/update.php?db=appointment" class="col" style="margin-left: 15%;">

            <!-- --Title -->
            <h2 style="text-align: center; font-size: 46px; width: 400px;">Welcome</h2>
            <!-- --Inputs -->
            <div style="width: 400px; text-align: center;">
                <?php include 'components/appointment_change_inputs.php' ?>
            </div>

            <br>
            <!-- --Submit Button -->
            <button type="submit" class="btn btn-primary button_signin" style="font-size: 20px;">Add
                Appointment</button>
        </form>
    </div>
    <!-- Content End -->
