...
<body id="bg_signin" class="actor" style="width: 99%;">
    ...
    <nav class="navbar navbar-expand-sm bg-none navbar-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" style="margin-right: 100px; padding-top: 15px;">
                ...
                <li class="nav-item">
                    <a class="nav-link nav_item nav_active" href="patients.php">Patients</a>
                </li>
                <li class="nav-item">
    ...
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="col">
            <h1 style="margin-left: 150px; font-size: 60px; width: 600px;">New Patient? <br> Create an Account!</h1>
        </div>

        <!-- --Input Form -->
        <form method="post" action="actions/create.php?db=patient" class="col" style="margin-left: 15%;">
            ...
            <!-- ----Medical Aid Number -->
            <div class="input-group mb-3 input_signin">
                <input type="text" style="border-right: 0px; border-color: black;" class="form-control" name="medaid"
                    placeholder="Enter Medical Aid Number" id="SignUp_Pass_Input">
                <button class="btn btn_signin" type="button" style="width: 50px;"><span>&#10005;</span></button>
            </div>
